        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="space-y-4">
              <h3 className="font-display text-xl font-semibold">Ángela Cervantes</h3>
              <p className="font-sans text-primary-foreground/80 leading-relaxed">
                Preservando y compartiendo la riqueza de la música tradicional española 
                con el mundo a través de interpretaciones auténticas y emotivas.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="font-sans text-xs text-primary-foreground/60">
                Management: Rocío Royo Durán<br />
