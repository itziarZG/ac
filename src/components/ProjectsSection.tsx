                ...
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="relative aspect-square md:aspect-auto md:h-auto overflow-hidden">
                    ...
                    {featuredProject.hover && (
                      <div className="absolute top-0 left-0 w-full z-10 bg-primary/80 text-primary-foreground font-display text-sm md:text-lg px-4 py-2 rounded-b-xl shadow-md">
                        {featuredProject.hover}
                      </div>
                    )}
                    <img
